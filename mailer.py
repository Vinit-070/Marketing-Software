...
class Email:
    ...
    def __init__(self, root):
        self.root = root
        self.root.title("Mailer - Marketing Software By Vinit Patel")
        ...
        title = Label(self.root, text="Bulk Email Sender Panel",font=("Goudy Old Style", 48, "bold"), bg="#272727",
        ...
        btn_set1 = Button(self.root, image=self.Email_icon,
                          bg="#272727", bd='0', command=LEFT, height=65, width=100,activebackground="blue").place(x=1, y=4)

        btn_set = Button(self.root,image=self.Setting_icon,
                         bg="#272727", bd='0', command=self.setting_window,height= 65, width=100,activebackground="blue",).place(x=890, y=4)
